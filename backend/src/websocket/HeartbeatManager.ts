...
export class HeartbeatManager {
  private readonly PING_INTERVAL = 15000; // Era 30000, agora 15 segundos
  private readonly PONG_TIMEOUT = 5000;   // Timeout para pong
  ...
  private stats: HeartbeatStats = {
    ...
    currentInterval: this.PING_INTERVAL,
