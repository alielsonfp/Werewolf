...
export default function RegisterPage() {
  ...
  const { register, login, handleAuthentication, isAuthenticated, isLoading } = useAuth();
  ...
  const handleGoogleLogin = useGoogleLogin({
    ...
    onError: (error) => {
      console.error('Registro com Google falhou:', error);
      toast.error('Não foi possível iniciar o registro com o Google.');
      setIsSubmitting(false);
    },
  });
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              ...
              handleGoogleLogin(); // Chamar a função correta
            }}
            className="w-full border border-white/20 hover:border-white/40 mb-6 flex items-center justify-center"
